...
ANDROID_DEFAULT_CJK_EDGE_VOICE = "zh-CN-XiaoxiaoNeural"
...
async def _generate_edge_tts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    ...
    if (
        os.environ.get("HERMES_ANDROID_EMBEDDED") == "1"
        and (not edge_config.get("voice") or voice == DEFAULT_EDGE_VOICE)
        and re.search(r"[\u3400-\u9fff]", text)
    ):
        voice = ANDROID_DEFAULT_CJK_EDGE_VOICE
